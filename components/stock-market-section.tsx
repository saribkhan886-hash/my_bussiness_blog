    ...
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="overflow-hidden">
          <img src="/business-meeting-handshake-professional.jpg" alt="Business relationship" className="w-full h-48 object-cover" />
          <div className="p-4">
            <h3 className="font-semibold mb-2 text-balance">What Your Relationship With Stock Market Says About You</h3>
