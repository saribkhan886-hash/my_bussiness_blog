      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card className="relative overflow-hidden h-96">
            <img src="/business-handshake-meeting-professional.jpg" alt="Business meeting" className="w-full h-full object-cover" />
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            <div className="flex gap-4">
              <img src="/business-meeting-office.png" alt="Business meeting" className="w-20 h-20 object-cover rounded" />
              <div className="flex-1">
                <h3 className="font-semibold text-sm mb-2 text-balance">
          ...
          <Card className="p-4">
            <div className="flex gap-4">
              <img src="/renewable-energy-solar-panels.png" alt="Renewable energy" className="w-20 h-20 object-cover rounded" />
              <div className="flex-1">
                <h3 className="font-semibold text-sm mb-2 text-balance">
